      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gridAutoRows: 'minmax(0, 1fr)', gap: 10, minHeight: 0, overflow: 'hidden' }}>
        ...
        <div style={{ display: 'grid', gridTemplateRows: 'auto auto minmax(0, 1fr)', gap: 10, minHeight: 0 }}>
          ...
          <div style={{
            ...
            <SectionHeader sec={SEC.input} extra={lang === 'ko' ? '값 변경 → 출력 즉시 반응' : 'change → output reacts live'} />
              ...
              {c.outputs.map(k => {
                ...
                return (
                  <div key={k} style={{
                    ...
                    <div style={{ fontFamily: 'JetBrains Mono', fontSize: 20, fontWeight: 700, marginTop: 4,
  ...
  return (
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, padding: 20, overflow: 'auto' }}>
