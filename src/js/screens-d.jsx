...
function LessonScreen({ s, set, L, lang, lessonN, closeLesson }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, height: 770, overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'grid', gridTemplateColumns: 'minmax(0, 1.55fr) minmax(330px, 0.9fr)', gap: 12, overflow: 'hidden' }}>

        {/* LEFT: scrollable article-style lesson document */}
        <div style={{ minHeight: 0, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 12, paddingRight: 8 }}>
          ...
          <div style={{
            ...
            <ol style={{ margin: 0, padding: '0 0 0 22px', fontSize: 13.5, color: '#1a2d5a', lineHeight: 1.72 }}>
              {c.obj[lang].map((o, i) => (
                <li key={i} style={{ marginBottom: 5, fontWeight: i === 0 ? 600 : 400 }}>{o}</li>
              ))}
            </ol>
          </div>

          {/* Principle + Formulas — PURPLE */}
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: 13.5, color: '#2e1e6e', lineHeight: 1.78 }}>
              {comp?.principle[lang]}
            </p>
          ...
          <div style={{
            ...
            <ol style={{ margin: 0, padding: '0 0 0 0', listStyle: 'none', fontSize: 13.25, color: '#143d28', lineHeight: 1.72 }}>
              {c.proc[lang].map((p, i) => (
        ...
        {/* RIGHT: compact control/observation rail */}
