...
function SchematicScreen({ s, set, L, onPick }) {
  ...
  const activeAlarms = s.alarms.filter(a => !a.ack).length;
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 268px', gridTemplateRows: 'minmax(0, 1fr) auto', gap: 8, height: '100%', overflow: 'hidden' }}>
      {/* ── SVG schematic ── */}
      ...
      <div style={{ gridColumn: '1', gridRow: '2', minHeight: 0 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(260px, 0.7fr) minmax(420px, 1.15fr)', gap: 8, width: '86%', maxWidth: 900 }}>
