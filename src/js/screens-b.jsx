...
function EnergyScreen({ s, L }) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateRows: '72px 120px 176px', gap: 6, height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.45fr 1fr', gap: 8, minHeight: 0 }}>
